...
namespace WebBanDienThoai.Areas.Admin.Controllers
{
    public class CategoriesController : BaseAdminController
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,CategoryName")] Category category)
        {
            ...
            {
                // ✅ Kiểm tra trùng tên
                if (db.Categories.Any(c => c.CategoryName.Equals(category.CategoryName, StringComparison.OrdinalIgnoreCase)))
                {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            {
                TempData["ErrorMessage"] = $"Không thể xóa! Danh mục '{category.CategoryName}' đang có {category.Products.Count} sản phẩm.";
                return RedirectToAction("Index");
            }
